...
public class Example01 {
	...
	public static void main(String[] args) {
		...
		System.out.print("소프트웨어 설계의 정답 개수를 입력해주세요 : ");
		int soft1=Integer.parseInt(scan.nextLine());
		System.out.print("소프트웨어 개발의 정답 개수를 입력해주세요 : ");
		int soft2=Integer.parseInt(scan.nextLine());
		System.out.print("데이터베이스 구축의 정답 개수를 입력해주세요 : ");
		int DB=Integer.parseInt(scan.nextLine());
		System.out.print("프로그래밍 언어활용의 정답 개수를 입력해주세요 : ");
		int pro=Integer.parseInt(scan.nextLine());
		System.out.print("정보시스템 구축의 정답 개수를 입력해주세요 : ");
